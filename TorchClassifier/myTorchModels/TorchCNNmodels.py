...
class MLP(nn.Module): #for MNIST dataset
    def __init__(self, input_dim, output_dim):
        ...
        self.input_fc = nn.Linear(input_dim, 512) #hidden dimensions of 250 elements
        self.bn1 = nn.BatchNorm1d(512)
        self.hidden_fc = nn.Linear(512, 256) #hidden dimensions of 100 elements
        self.bn2 = nn.BatchNorm1d(256)
        self.hidden_fc2 = nn.Linear(256, 128)
    ...
    def forward(self, x):
        ...
        h_1 = F.relu(self.bn1(self.input_fc(x)))
       

        h_2 = F.relu(self.bn2(self.hidden_fc(h_1)))
        

        h_3 = F.relu(self.hidden_fc2(h_2))

        h_4 = self.dropout(h_3)
