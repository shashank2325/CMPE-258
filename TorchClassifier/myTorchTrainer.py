...
os.environ['TORCH_HOME'] = '/Users/shashu/torchhome/' #setting the environment variable
...
parser.add_argument('--resume', default="outputs/mnist_1/model_best.pth.tar", type=str, metavar='PATH',
...
def main():
    ...
    print("Model before moving to device:", model_ft)
